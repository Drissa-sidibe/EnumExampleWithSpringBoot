package com.bamada.bamadaSpringBoot.model;
...
public class SurveyService {
	...
	static {
		...
		//Survey1
		Survey survey1 = new Survey("Survey1","Abu-Leila Survey","World Classification",questions);
		surveys.add(survey1);
		Survey survey2 = new Survey("Survey2","Something Else","World Classification",questions);
		surveys.add(survey2);
		Survey survey3 = new Survey("Survey3","Abu-Leila Survey","World Classification",questions);
		surveys.add(survey2);
	}
